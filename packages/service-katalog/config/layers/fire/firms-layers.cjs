module.exports = function ({ wmtsUrl, tmsUrl, wmsUrl, wcsUrl, k2Url, s3Url }) {
  return [{
    ...
    i18n: {
      fr: {
        Layers: {
          FIRMS: 'FIRMS - VIIRS 375m',
          FIRMS_DESCRIPTION: 'Points chauds (Fire Information for Resource Management System - VIIRS 375m - S-NPP)'
        },
        Variables: {
      ...
      en: {
        Layers: {
          FIRMS: 'FIRMS - VIIRS 375m',
          FIRMS_DESCRIPTION: 'Thermal hotspots (Fire Information for Resource Management System - VIIRS 375m - S-NPP)'
        },
        Variables: {
